...
*/
package com.github.ppamorim.flapbar;
 ...
 *
 */
public class FlapBar extends FrameLayout {
  ...
  private FlapBarHelperCallback flapBarHelperCallback;
  private ViewDragHelper dragHelper;

  public FlapBar(Context context) {
    super(context);
  }

  public FlapBar(Context context, AttributeSet attrs) {
    super(context, attrs);
    initializeAttributes(attrs);
  }

  public FlapBar(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void configDragViewHelper() {
    flapBarHelperCallback = new FlapBarHelperCallback(this, dragView);
